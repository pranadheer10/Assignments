...
<title>Buy-<%=application.getInitParameter("applicationName") %></title>
<style>
ul {
...
<div>
<form name= "myform" action="buyPage" method="post">
...
<h4>Welcome to shoppers.com you are about to buy items...! <%=userName %> </h4>
<table>
<tr>
